      ...
      <div className="relative flex flex-col h-full px-4 md:px-8">
        ...
        <div className="flex-1 relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <h1 className="text-[96px] md:text-[clamp(100px,13.75vw,198px)] font-medium text-white mix-blend-overlay text-center capitalize tracking-[-0.07em] leading-[0.9] whitespace-pre-wrap md:whitespace-nowrap w-full">
              Harvey   Specter
            </h1>
          </div>
